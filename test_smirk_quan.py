...
if __name__ == "__main__":
    ...
    parser.add_argument('--chkpnt_number', type=int, default=150000, help='')
    ...
    scene = Scene_mica_smirk(data_dir, mica_datadir, train_type=3, white_background=lpt.white_background,id_name=args.idname, quan_bits=args.quan_bit, device = args.device)
    ...
    # vid_save_path_rec = os.path.join(logdir, f'rec_{args.quan_bit}bit_exp_dim{args.exp_dim_used_in50}_{args.chkpnt_number}_frame1000.avi')
    vid_save_path_rec = os.path.join(logdir, f'rec_{args.quan_bit}bit_exp_dim{args.exp_dim_used_in50}_{args.chkpnt_number}_frame500.avi')
