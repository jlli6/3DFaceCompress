...
if __name__ == "__main__":
    ...
    # parser.add_argument("--checkpoint_gaussian", type=str, default = "/home/ljl/workspace/ICME2025/LIC_TCM/dataset/rec/rec_Obama.pth")
    parser.add_argument("--checkpoint_gaussian", type=str, default = "/home/ljl/workspace/IBC24/FlashAvatar-code/pretrained_model/Obama_simplifed_gaussian.pth")
    ...
    if args.checkpoint_gaussian:
        gauss_params_simple= torch.load(args.checkpoint_gaussian)
        gaussians.restore_smiple(gauss_params_simple, opt)
    ...
    for iteration in range(len(viewpoint)):
        ...
        # cv2.imwrite(os.path.join(test_output_dir, f'{frame_id}.png'), save_image)
