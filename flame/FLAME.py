...
from .lbs_smirk import lbs, batch_rodrigues, vertices2landmarks, rot_mat_to_euler
...
class FLAME(nn.Module):
    ...
    def __init__(self, config):
        ...
        # print("flame_model:", flame_model)
        self.n_shape =config.num_shape_params
        self.n_exp = config.num_exp_params
        ...
        print("num_pose_basis:", num_pose_basis)
        ...
        # default_pose = torch.zeros([1, 3], dtype=self.dtype, requires_grad=False)
        # self.register_parameter('pose_params', nn.Parameter(default_pose,
        #                                                   requires_grad=False))
        ...
        lmk_embeddings_mp = np.load('flame/mediapipe/mediapipe_landmark_embedding.npz', allow_pickle=True, encoding='latin1')
    ...
    def forward(self, param_dictionary, zero_expression=False, zero_shape=False, zero_pose=False):
        ...
        trans_params = torch.zeros(batch_size, 3).cuda() # mica flame
        ...
        # print("full pose shape:", full_pose.shape)
