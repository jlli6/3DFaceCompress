...
from flame.lbs_mica import lbs
...
class FLAME_mica(nn.Module):
    ...
    def __init__(self, config):
        ...
        # smirk code
        # self._register_default_params('neck_pose_params', 3)
        # self._register_default_params('jaw_pose_params', 3)
        # self._register_default_params('eye_pose_params', 12)
    ...
    def _forward_geo(self, shape_params, trans_params=None, rot_params=None, neck_pose_params=None, jaw_pose_params=None, eye_pose_params=None, expression_params=None, eyelid_params=None):
        batch_size = shape_params.shape[0]
        I = matrix_to_rotation_6d(torch.cat([torch.eye(3)[None]] * batch_size, dim=0).cuda())
    ...
    def forward_geo(self, shape_params, trans_params=None, rot_params=None, neck_pose_params=None, jaw_pose_params=None, eye_pose_params=None, expression_params=None, eyelid_params=None):
        ...
        # else: # 将轴角转为旋转矩阵
        #     rot_params = axis_angle_to_matrix(rot_params)
        #     rot_params = matrix_to_rotation_6d(rot_params)
        ...
        if jaw_pose_params is None:
            jaw_pose_params = I.clone()
        # else:
        #     jaw_pose_params = axis_angle_to_matrix(jaw_pose_params)
        #     jaw_pose_params = matrix_to_rotation_6d(jaw_pose_params)
