...
smirk_id_list = ["id2_smirk","id1_smirk"]
smirk_id_list = ["id2_smirk","id5_smirk"]
quan_bit_list = [8,10]
...
for smirk_id in smirk_id_list:
    for quan_bit in quan_bit_list:
        for exp_dim in exp_dim_list:
            command = f'CUDA_VISIBLE_DEVICES="0" /home/ljl/workspace/ICME2025/LIC_TCM/tcm_venv/bin/python train_smirk_eagles.py \
