...
id_name_list_emoca = ["id4_emoca", "id5_emoca","id7_emoca", "id8_emoca"]
# id_name_list= ["Obama"]
for idname in id_name_list_emoca:
    ...
    for chkpnt in range(55000, 150001, 5000):
        ...
        # 运行 test_smirk.py
        command = f'CUDA_VISIBLE_DEVICES="3" /home/xylem/IBC24/CPEM/CPEM-env/bin/python {script_name} --idname {idname} --checkpoint {checkpoint_file} --logname {logname} --flame {flame_type}'
