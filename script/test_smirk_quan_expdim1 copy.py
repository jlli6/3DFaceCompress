    ...
    for quan_bit in quan_bit_list:
        ...
        for exp_dim in exp_dim_list:
            ...
            for chkpnt in chkpnts:
                ...
                # 运行 test_smirk.py
                command = f'CUDA_VISIBLE_DEVICES="1" /home/xylem/IBC24/CPEM/CPEM-env/bin/python {script_name} --idname {idname} --checkpoint {checkpoint_file} --logname {logname} --quan_bit {quan_bit} --exp_dim {exp_dim} --chkpnt_number {chkpnt}'
