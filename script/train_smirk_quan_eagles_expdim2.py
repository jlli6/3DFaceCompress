...
# exp_dim_list = {10}
smirk_id_list = ["id1_smnirk","id2_smirk","id4_smirk","id5_smirk","id8_smirk","Obama_smirk","ljl_smirk","xj_smirk"] # ,"id5_smirk","id7_smirk","id8_smirk","Obama_smirk","ljl_wo_glass_smirk"]
smirk_id_list = ["id8_smirk","Obama_smirk"]

quan_bit_list = [8,10]

smirk_id_list = ["Obama_smirk"] #Obama 不剪枝
exp_dim_list = {10}
quan_bit_list = [10]
    ...
    for quan_bit in quan_bit_list:
        for exp_dim in exp_dim_list:
            command = f'CUDA_VISIBLE_DEVICES="2" /home/ljl/workspace/ICME2025/LIC_TCM/tcm_venv/bin/python train_smirk_eagles.py \
                ...
                --logname log_smirk_eagles_mlp6_rest141_purn0_quan{quan_bit}_exp_dim_{str(exp_dim)}_retain \
