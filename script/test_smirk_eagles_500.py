...
for idname in id_name_list_smirk:
    ...
    for quan_bit in quan_bit_list:
        ...
        for exp_dim in exp_dim_list:
            ...
            logname =f"log_smirk_eagles_mlp6_rest141_purn0_quan{quan_bit}_exp_dim_{str(exp_dim)}_retain"
            ...
            # 保存到文件
            output_file = os.path.dirname(base_checkpoint_path) + f"/quan_exp_dim_psnr_results_frame500.txt"
